...
def construir_tabla_detalle_html(titulo, subtitulo, tabla_bloque, ocultar_columnas=None):
    ...
    ocultar_css = "\n".join(
        f"      th.{clase}, td.{clase} {{ width: 0; padding: 0 !important; "
        f"overflow: hidden; border: none !important; }}"
    ...
    <style>
      * {{ margin:0; padding:0; box-sizing:border-box; }}
      ...
      .col-pais {{ width: 150px; text-align: left !important; padding-left: 15px !important; }}
